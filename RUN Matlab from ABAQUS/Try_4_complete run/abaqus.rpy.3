...
# Run by p4wp4w on Sat Feb 20 10:08:45 2016
#
...
#: Error in job closedloop_step: Unable to delete file(s) C:\Users\p4wp4w\AppData\Local\Temp\p4wp4w_closedloop_step_6236. Please check that you have file ownership and permissions for removal.
mdb.jobs['closedloop_step'].submit(consistencyChecking=OFF)
#: The job input file "closedloop_step.inp" has been submitted for analysis.
...
#: Error in job closedloop_step: Unable to delete file(s) C:\Users\p4wp4w\AppData\Local\Temp\p4wp4w_closedloop_step_4288. Please check that you have file ownership and permissions for removal.
#: Job closedloop_step aborted due to errors.
mdb.jobs['closedloop_step'].submit(consistencyChecking=OFF)
#: The job input file "closedloop_step.inp" has been submitted for analysis.
#: Job closedloop_step: Analysis Input File Processor completed successfully.
#: ERROR in job messaging system: Error in connection to analysis
#: Error in job closedloop_step: Unable to delete file(s) C:\Users\p4wp4w\AppData\Local\Temp\p4wp4w_closedloop_step_5864. Please check that you have file ownership and permissions for removal.
#: Job closedloop_step aborted due to errors.
mdb.jobs['closedloop_step'].submit(consistencyChecking=OFF)
#: The job input file "closedloop_step.inp" has been submitted for analysis.
#: Job closedloop_step: Analysis Input File Processor completed successfully.
...
#: Job closedloop_step: Analysis Input File Processor completed successfully.
#: ERROR in job messaging system: Error in connection to analysis
#: Error in job closedloop_step: Unable to delete file(s) C:\Users\p4wp4w\AppData\Local\Temp\p4wp4w_closedloop_step_6272. Please check that you have file ownership and permissions for removal.
#: Job closedloop_step aborted due to errors.
mdb.jobs['closedloop_step'].submit(consistencyChecking=OFF)
#: The job input file "closedloop_step.inp" has been submitted for analysis.
#: Job closedloop_step: Analysis Input File Processor completed successfully.
...
#: Error in job closedloop_step: Process terminated by external request (SIGTERM or SIGINT received).
#: Job closedloop_step: Abaqus/Standard was terminated prior to analysis completion.
#: Error in job closedloop_step: Unable to delete file(s) C:\Users\p4wp4w\AppData\Local\Temp\p4wp4w_closedloop_step_3012. Please check that you have file ownership and permissions for removal.
mdb.jobs['closedloop_step'].submit(consistencyChecking=OFF)
#: The job input file "closedloop_step.inp" has been submitted for analysis.
#: Job closedloop_step: Analysis Input File Processor completed successfully.
o3 = session.openOdb(name='C:/Temp/closedloop_step.odb')
...
#: Error in job closedloop_step: Process terminated by external request (SIGTERM or SIGINT received).
#: Job closedloop_step: Abaqus/Standard was terminated prior to analysis completion.
#: Error in job closedloop_step: Unable to delete file(s) C:\Users\p4wp4w\AppData\Local\Temp\p4wp4w_closedloop_step_4192. Please check that you have file ownership and permissions for removal.
mdb.jobs['closedloop_step'].submit(consistencyChecking=OFF)
#: The job input file "closedloop_step.inp" has been submitted for analysis.
#: Job closedloop_step: Analysis Input File Processor completed successfully.
mdb.jobs['closedloop_step'].kill()
#: Error in job closedloop_step: Process terminated by external request (SIGTERM or SIGINT received).
#: Job closedloop_step: Abaqus/Standard was terminated prior to analysis completion.
#: Error in job closedloop_step: Unable to delete file(s) C:\Users\p4wp4w\AppData\Local\Temp\p4wp4w_closedloop_step_5648. Please check that you have file ownership and permissions for removal.
mdb.jobs['closedloop_step'].submit(consistencyChecking=OFF)
#: The job input file "closedloop_step.inp" has been submitted for analysis.
#: Job closedloop_step: Analysis Input File Processor completed successfully.
o3 = session.openOdb(name='C:/Temp/closedloop_step.odb')
...
odb = session.odbs['C:/Temp/closedloop_step.odb']
xy1 = xyPlot.XYDataFromHistory(odb=odb, 
    outputVariableName='Spatial displacement: U3 PI: CYLINDER-1 Node 26 in NSET SET-1', 
    )
c1 = session.Curve(xyData=xy1)
xyp = session.xyPlots['XYPlot-1']
chartName = xyp.charts.keys()[0]
...
#: Error in job closedloop_step: Process terminated by external request (SIGTERM or SIGINT received).
#: Job closedloop_step: Abaqus/Standard was terminated prior to analysis completion.
#: Error in job closedloop_step: Unable to delete file(s) C:\Users\p4wp4w\AppData\Local\Temp\p4wp4w_closedloop_step_6540. Please check that you have file ownership and permissions for removal.
mdb.save()
#: The model database has been saved to "C:\Temp\NewCylinderWithSubroutine.cae".
